            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {FLEET.map((v) => (
                <motion.button
                  ...
                  className="relative w-full rounded-3xl border border-white/10 p-5 text-left shadow-xl transition hover:border-sky-400/60 focus:outline-none focus:ring-2 focus:ring-sky-400"
