...
export default function Home() {
  ...
  return (
    <div className="bg-black text-white min-h-screen relative font-sans">
      ...
      <section id="what-we-do" className="relative z-10 px-6 py-16 bg-black scroll-mt-28 md:scroll-mt-32">
        <div className={`${CONTAINER}`}>
          ...
          >
            <p className="text-lg md:text-xl text-sky-100/90 mb-8">
              Novator Group delivers rapid, reliable solutions for crisis and critical operations. We provide modular power, connectivity, security, and AI driven tools to stabilize and command any environment.
            </p>
            ...
            <div className="mt-8">
              <Link
                href="/about#mission-highlight"
                className={BTN_SOLID}
                aria-label="View mission highlights"
              >
                Mission Highlight
              </Link>
            </div>
