...
highlights: string[];
image: string;
details: string[]; // New field for expanded section
};
/** ======= Helpers ======= */
...
<link rel="icon" href="/lb.png" />
<link rel="apple-touch-icon" href="/lb.png" sizes="180x180" />
<style>{`
...
<div className="backdrop-blur-sm bg-black/30 rounded-2xl px-4 sm:px-6 py-4 border border-white/10 inline-block">
<div className="grid grid-cols-2 gap-6 sm:gap-8 text-center">
{stats.map(({ value, label }) => (
<div key={label}>
<div className="text-xl sm:text-2xl md:text-3xl font-extrabold leading-tight">
{value}
</div>
